...
[React Hooks](https://react.dev/reference/react) have revolutionized how we manage logic and side effects in functional components, but two hooks—[useCallback](https://react.dev/reference/react/useCallback) and [useMemo](https://react.dev/reference/react/useMemo)—are frequently misunderstood and overused in the process of obsessively trying to memoise.
