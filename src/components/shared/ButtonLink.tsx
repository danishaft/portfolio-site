...
const ButtonLink = (props: ButtonLinkProps): React.ReactElement => {
  ...
  const buttonClasses = 'bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 py-2 px-3 rounded shadow-sm border border-solid border-gray-300 dark:border-gray-600';
