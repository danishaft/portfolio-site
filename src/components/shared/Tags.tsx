...
const getTechLogo = (name: string): string | null => {
  const logoMap: Record<string, string> = {
    ...
    "REST APIs": "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apache/apache-original.svg",
    ...
    "Chrome Extensions": "https://www.google.com/chrome/static/images/chrome-logo.svg",
